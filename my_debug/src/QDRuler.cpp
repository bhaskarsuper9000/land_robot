...
QDRuler::QDRuler(QDRuler::RulerType rulerType)//, QWidget* parent)
	: /*QWidget(parent),*/ mRulerType(rulerType), mOrigin(0.), mRulerUnit(1.),mRulerZoom(1.), mDrawText(false)
{
    setMouseTracking(true);
    QFont txtFont("SansSerif",10,20);
    txtFont.setStyleHint(QFont::Times,QFont::PreferBitmap);
    setFont(txtFont);
    if(QDRuler::Horizontal == rulerType) this->setMaximumHeight(15);
    if(QDRuler::Vertical== rulerType) this->setMaximumWidth(15);
